...
enum CognitoUserState : NSInteger;
@class CognitoSignInResult;
@class TokensHelper;
@class NSError;

SWIFT_CLASS("_TtC15AWSMobileClient21AWSMobileClientHelper")
@interface AWSMobileClientHelper : NSObject
+ (AWSMobileClient * _Nonnull)getAWSMobileClientWithConfiguration:(NSDictionary<NSString *, id> * _Nonnull)configuration SWIFT_WARN_UNUSED_RESULT;
+ (void)signOutWithMobileClient:(AWSMobileClient * _Nonnull)mobileClient completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
+ (void)addUserStateListeners:(AWSMobileClient * _Nonnull)mobileClient completionHandler:(void (^ _Nonnull)(enum CognitoUserState, NSDictionary<NSString *, NSString *> * _Nullable))completionHandler;
+ (void)removeUserStateListeners:(AWSMobileClient * _Nonnull)mobileClient;
+ (void)signIn:(AWSMobileClient * _Nonnull)mobileClient username:(NSString * _Nonnull)username password:(NSString * _Nonnull)password clientMetaData:(NSDictionary<NSString *, NSString *> * _Nonnull)clientMetaData completionHandler:(void (^ _Nonnull)(CognitoSignInResult * _Nullable, NSError * _Nullable))completionHandler;
+ (void)getTokens:(AWSMobileClient * _Nonnull)mobileClient completion:(void (^ _Nonnull)(TokensHelper * _Nullable, NSError * _Nullable))completion;
+ (void)initialize:(AWSMobileClient * _Nonnull)mobileClient loginCheckCompletion:(void (^ _Nonnull)(enum CognitoUserState, NSError * _Nullable))loginCheckCompletion;
+ (BOOL)isSignedIn:(AWSMobileClient * _Nonnull)mobileClient SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

enum CognitoSignInState : NSInteger;

SWIFT_CLASS("_TtC15AWSMobileClient19CognitoSignInResult")
@interface CognitoSignInResult : NSObject
@property (nonatomic, readonly) enum CognitoSignInState signInState;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull parameters;
- (NSString * _Nonnull)getSignInState SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, CognitoSignInState, closed) {
  CognitoSignInStateUnknown = 0,
  CognitoSignInStateSmsMFA = 1,
  CognitoSignInStatePasswordVerifier = 2,
  CognitoSignInStateCustomChallenge = 3,
  CognitoSignInStateDeviceSRPAuth = 4,
  CognitoSignInStateDevicePasswordVerifier = 5,
  CognitoSignInStateAdminNoSRPAuth = 6,
  CognitoSignInStateNewPasswordRequired = 7,
  CognitoSignInStateSignedIn = 8,
};

typedef SWIFT_ENUM(NSInteger, CognitoUserState, closed) {
  CognitoUserStateSignedIn = 0,
  CognitoUserStateSignedOut = 1,
  CognitoUserStateSignedOutFederatedTokensInvalid = 2,
  CognitoUserStateSignedOutUserPoolsTokenInvalid = 3,
  CognitoUserStateGuest = 4,
  CognitoUserStateUnknown = 5,
};
...
SWIFT_CLASS("_TtC15AWSMobileClient12TokensHelper")
@interface TokensHelper : NSObject
